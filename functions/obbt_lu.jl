...
function solve_obbt_load_opf!(file::String, optimizer; kwargs...)
    data = PowerModels.parse_file(file)
    return solve_obbt_load_opf!(data, optimizer; kwargs...)
end

function solve_obbt_load_opf!(data::Dict{String,<:Any}, optimizer;
    model_type::Type = QCRMPowerModel,
    max_iter::Int = 100,
    ...
    model_relaxation = instantiate_model(data, model_type, build_opf_load)
    ...
    model_bt = instantiate_model(data, model_type, build_opf_load)
    ...
    vm = PowerModels.var(model_bt, :vm)
    td = PowerModels.var(model_bt, :td)
    ...
    return data, stats, modifications
...
function solve_obbt_mod_opf!(data::Dict{String,<:Any}, optimizer;
