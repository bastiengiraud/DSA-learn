...
parent_temp = "/dev/shm"
custom_temp = "tempdir_imp" # make custom name for temp folder
...
df_macros_total(elapsed_time, num_boundary_ops, 0, 0.0, Initialize.directory, Initialize.imp_macros)
